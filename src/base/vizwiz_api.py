...
class VizWiz:
    def __init__(
        self, annotation_file=None, ignore_rejected=True, ignore_precanned=True
    ):
        """
...
# Commenting this out. Shouldn't be instantiating and printing during import
if False:
    dataset = VizWiz(
    ...
    print(dataset.getImgIds()[20:40])

    print(dataset.loadAnns(dataset.getAnnIds()[20:40]))
