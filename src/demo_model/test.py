...
DEMO_SAVE_PATH_1 = DEMO_SAVE_PATH + f"/submission/{optim}_{lr}_{beta1}_{beta2}"
...
DEMO_SAVE_PATH_1_model = DEMO_SAVE_PATH + f"/subset/{optim}_{lr}_{beta1}_{beta2}"
MODEL_PATH = f"{DEMO_SAVE_PATH_1_model}/best_model"
