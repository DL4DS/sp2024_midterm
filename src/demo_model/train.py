...
# momentum = 0.09 for SGD

DEMO_SAVE_PATH_1 = DEMO_SAVE_PATH + f"/subset/{optim}_{lr}_{beta1}_{beta2}"
...
try:
    ...
    # optimizer = torch.optim.SGD(model.parameters(), lr = lr, momentum = momentum)   # pick one from torch.optim
