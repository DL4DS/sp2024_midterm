...
train_dataloader = DataLoader(train_dataset, shuffle=True, batch_size=8) #original 8
val_dataloader = DataLoader(val_dataset, shuffle=False, batch_size=32) # original 32
